...
void EncyclopediaDialog::buildCatalog()
{
    ...
    boss.entries = {
        ...
        {QStringLiteral("B02"), QStringLiteral("塔利海怪"), QStringLiteral("已发现"),
         ...
         true, QColor("#9d3737")},
        {QStringLiteral("B03"), QStringLiteral("塞王女妖"), QStringLiteral("已发现"),
         QStringLiteral(":/FishingVoyage/encyclopedia/boss_siren.png"),
         QStringLiteral(":/FishingVoyage/encyclopedia/boss_siren.png"),
         {stat(QStringLiteral("名称"), QStringLiteral("塞王女妖")),
          stat(QStringLiteral("HP（初始）"), QStringLiteral("3,000")),
          stat(QStringLiteral("阶段数"), QStringLiteral("2 阶段")),
          stat(QStringLiteral("出现关卡"), QStringLiteral("第 5 关 Boss")),
          stat(QStringLiteral("技能"), QStringLiteral("灵魂歌声 / 终焉挽歌 / 潮汐回归")),
          stat(QStringLiteral("击败收益"), QStringLiteral("1,200"))},
         QStringLiteral("月色下吟唱的深海女王。她的歌声会腐蚀意志，也会让海面本身成为敌人。"),
         true, QColor("#9d3737")},
